...
<div class="modal midsize content hide" id="importExcelModalId">
    ...
    <div class="modal-body">
    	<div class="top">
			...
			<input type="button" class="function" name="btnDownload" id="btnDownload" value="<bean:message bundle="public" key="button.download.template" />" onclick="link('employeePositionChangeBatchAction.do?proc=export_template');" />
	    </div>
...
<script type="text/javascript">
	...
	var uploadObjectExcel = createUploadExcel('btnImportExcelFile','uploadFileAction.do?proc=importExcel4EmployeePositionChange&description=' + $('#description').val(),'uploadFileAction.do?proc=getStatusMessage','common', 'tempForExcel','');
