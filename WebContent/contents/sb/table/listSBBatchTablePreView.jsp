			...
			<tbody>
				<logic:iterate id="sbBatchVO" name="sbBatchHolder" property="source" indexId="number">
					<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
						<td><input type="checkbox" id="kanList_chkSelectRecord_<bean:write name="sbBatchVO" property="batchId"/>" name="chkSelectRow[]" value="<bean:write name="sbBatchVO" property="encodedId"/>" /></td>
						<td class="left"><a onclick="link('sbHeaderAction.do?proc=list_object&statusFlag=preview&batchId=<bean:write name="sbBatchVO" property="encodedId"/>');"><bean:write name="sbBatchVO" property="batchId" /></a>&nbsp;&nbsp;&nbsp;<a onclick="link('sbHeaderAction.do?proc=list_object&statusFlag=preview&batchId=<bean:write name="sbBatchVO" property="encodedId"/>');"></a></td>								
						...
						<td class="left">
							...
							%>
								<logic:equal name="role" value="1">
									客户：<bean:write name="sbBatchVO" property="countClientId" />；
									订单：<bean:write name="sbBatchVO" property="countOrderId" />；
									社保公积金人次：<bean:write name="sbBatchVO" property="countContractId" />；
								</logic:equal>
								<logic:equal name="role" value="2">
									结算规则：<bean:write name="sbBatchVO" property="countOrderId" />；
									社保公积金人次：<bean:write name="sbBatchVO" property="countContractId" />；
								</logic:equal>
							...
							%>
								<logic:equal name="role" value="1">
									Clinet: <bean:write name="sbBatchVO" property="countClientId" />;
								...
								<logic:lessThan name="sbBatchVO" property="employeeListSize" value="6">
									Employee(<bean:write name="sbBatchVO" property="countEmployeeId" /> people): <bean:write name="sbBatchVO" property="employeeNameList" />
								</logic:lessThan>
							<%
								}
							%>
			...
			<tfoot>
				<tr class="total">
					<td colspan="10" class="left">
						...
						<label>&nbsp;&nbsp;<a onclick="submitForm('list_form', null, '<bean:write name="sbBatchHolder" property="firstPage" />', null, null, 'tableWrapper');"><bean:message bundle="public" key="page.first" /></a></label> 
						<label>&nbsp;<a onclick="submitForm('list_form', null, '<bean:write name="sbBatchHolder" property="previousPage" />', null, null, 'tableWrapper');"><bean:message bundle="public" key="page.previous" /></a></label> 
						<label>&nbsp;<a onclick="submitForm('list_form', null, '<bean:write name="sbBatchHolder" property="nextPage" />', null, null, 'tableWrapper');"><bean:message bundle="public" key="page.next" /></a></label> 
						<label>&nbsp;<a onclick="submitForm('list_form', null, '<bean:write name="sbBatchHolder" property="lastPage" />', null, null, 'tableWrapper');"><bean:message bundle="public" key="page.last" /></a></label> 
