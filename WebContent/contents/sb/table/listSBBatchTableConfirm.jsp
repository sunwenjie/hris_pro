		...
		<tbody>
			<logic:iterate id="sbBatchVO" name="sbBatchHolder" property="source" indexId="number">
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					<td><logic:empty name="sbBatchVO" property="workflowId" >
							<input type="checkbox" <logic:greaterEqual name="sbBatchVO" property="additionalStatus" value="13">class="hide"</logic:greaterEqual> id="kanList_chkSelectRecord_<bean:write name="sbBatchVO" property="encodedId"/>" name="chkSelectRow[]" value="<bean:write name="sbBatchVO" property="encodedId"/>" />
						</logic:empty>
					</td>
					<td class="left"><a href="#" onclick="link('sbHeaderAction.do?proc=list_object&statusFlag=confirm&batchId=<bean:write name="sbBatchVO" property="encodedId"/>');"><bean:write name="sbBatchVO" property="batchId" /></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="link('sbHeaderAction.do?proc=list_object&statusFlag=confirm&batchId=<bean:write name="sbBatchVO" property="encodedId"/>');"></a></td>								
					...
					<td class="left">	
						...
						%>							
							<logic:equal name="role" value="1">
								客户：<bean:write name="sbBatchVO" property="countClientId" />；订单：<bean:write name="sbBatchVO" property="countOrderId" />；社保公积金人次：<bean:write name="sbBatchVO" property="countContractId" />；
							</logic:equal>
						...
						%>
							...
							<logic:greaterThan name="sbBatchVO" property="employeeListSize" value="5">
								Employee(<bean:write name="sbBatchVO" property="countEmployeeId" /> people): <bean:write name="sbBatchVO" property="employeeNameTop5List" />
								<img src="images/tips.png" title="<bean:write name="sbBatchVO" property="employeeNameList" />" />
							</logic:greaterThan>
							<logic:lessThan name="sbBatchVO" property="employeeListSize" value="6">
					...
					<td class="left">
					<logic:empty name="sbBatchVO" property="workflowId" >
						<bean:write name="sbBatchVO" property="decodeAdditionalStatus" />
					</logic:empty>
					<logic:notEmpty name="sbBatchVO" property="workflowId" >
						<bean:write name="sbBatchVO" property="decodeAdditionalStatus" />审核中
