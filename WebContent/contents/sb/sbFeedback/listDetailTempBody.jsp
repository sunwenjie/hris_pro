...
<div id="content">
	...
	<div class="box">
	    ...
	    <div class="inner">
	        <html:form action="sbFeedbackDetailTempAction.do?proc=list_object" styleClass="listDetailTemp_form">
		        <div class="top">
					<input type="button" class="reset" name="btnBack" id="btnBack" value="返回上一层" onclick="if(agreest()){link('sbFeedbackHeaderTempAction.do?proc=list_object&batchId=<bean:write name="commonBatchVO" property="encodedId"/>')};" />
