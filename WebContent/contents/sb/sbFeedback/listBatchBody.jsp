...
<div id="content">
	<div class="box searchForm toggableForm" id="sbTempBatch-information">
		<div class="head"><label id="itleLable">申报反馈</label></div>
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			<div class="top">
				...
				<img style='float:right' src='images/import.png' onclick='popupExcelImport();' title='申报反馈' />
			</div>
			<!-- top -->
			<div id="tableWrapper">
...
<script type="text/javascript">
	(function($) {
		...
		$('#searchDiv').hide();
		$('#importExcelTitleLableId').html('申报反馈');
