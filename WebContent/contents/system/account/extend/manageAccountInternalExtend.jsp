...
<div id="tab"> 
	<div class="tabMenu"> 
		<ul> 
			<li id="tabMenu1" onClick="changeTab(1,1)" class="first hover" >企业形象 <img src="images/tips.png" title="推荐图片比例4:3 （800*600，400*300）"></li> 
		</ul> 
	</div> 
		...
		<div id="tabContent1" class="kantab kanMultipleChoice1">
			...
			<div id="attachmentsDiv">
				<ol id="attachmentsOL" class="auto thumb" >
					...
					<%= AttachmentRender.getPhotos(request, accountVO.getImageFile(), null) %>
				</ol>
			</div>
		</div>
	</div>
