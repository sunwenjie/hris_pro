		...
		<tbody>
			<logic:iterate id="commonBatchVO" name="employeeContractBatchHolder" property="source" indexId="number">
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					...
					<td class="left"> <a onclick="link('employeeContractTempAction.do?proc=list_object&batchId=<bean:write name="commonBatchVO" property="batchId"/>');"><bean:write name="commonBatchVO" property="batchId" /></a></td>								
