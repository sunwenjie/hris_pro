...
<html:form action="systemInvoiceHeaderAction.do?proc=add_objectBycombine"  styleClass="subInvoice_form">
	<%= BaseAction.addToken( request ) %>
	<input type="hidden" id="batchId" name="batchId" value="<bean:write name='headerForm' property='encodedBatchId'/>" />
	<input type="hidden" name="pageFlag" id="pageFlag" value="Merge" />
		<fieldset>
 		<ol class="auto">
		...
		<ol class="auto">	
			...
			<li>
				...
				<html:text property="billAmountCompany" maxlength="10" styleClass="subInvoice_billAmountCompany" readonly="true"/>
			</li>
			<li>
				<label>公司成本（元）<em> *</em></label> 
				<html:text property="costAmountCompany" maxlength="10" styleClass="subInvoice_costAmountCompany" readonly="true"/>
			</li>
			<li>
