...
<div id="content">	
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			...
			<div class="top">
				<input type="button" class="reset" id="backBatchList" value="<bean:message bundle="public" key="button.list" />" />
				<a id="filterRecords" name="filterRecords"><bean:message bundle="public" key="set.filerts" /></a>
			</div>
			<!-- top -->
			<div id="tableWrapper">
				<!-- Include table jsp 包含tabel对应的jsp文件 -->  
				<jsp:include page="/contents/business/employee/contract/table/listEmployeeContractHeaderUpdateTableInHouse.jsp" flush="true"/>
			</div>
			<div class="bottom">
				<p>
			</div>
...
<script type="text/javascript">	
	...
	$(".list_form ol").append($("#tempStatusOL").html());
	 ...
	 // 修改Action 地址
	 $(".list_form").attr('action','employeeContractTempAction.do?proc=list_batch').append('<input type="hidden" name="batchId" id="batchId" value="<bean:write name="employeeContractTempForm" property="batchId" />" />');
	//批次更新事件
	...
	// 列表按钮点击事件
	$('#backBatchList').click( function(){
		link('employeeContractBatchAction.do?proc=list_batch');
	});
