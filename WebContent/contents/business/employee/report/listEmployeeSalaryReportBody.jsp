	...
	<div class="box searchForm toggableForm" id="Search-Information">
		<div class="head">
   	    ...
   	    <div id="searchDiv" class="inner" style="display: none;">
       		...
       		<html:form action="employeeReportAction.do?proc=list_employee_salary_object" method="post" styleClass="searchEmployeeReport_form">
				...
				<fieldset>
					<ol class="auto">
					   ...
					   <li>
						...
						<li>
							<label>薪资开始时间早于</label>
							<input type="text" name="salaryStartDateStart" class="Wdate search_salaryStartDateStart" id="search_salaryStartDateStart" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'search_salaryStartDateEnd\')||\'2020-10-01\'}'})"  value="<bean:write name="employeeReportForm" property="salaryStartDateStart" />"/>
						</li>
						<li>
							<label>薪资开始时间晚于</label>
							<input type="text" name="salaryStartDateEnd" class="Wdate search_salaryStartDateEnd" id="search_salaryStartDateEnd" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'search_salaryStartDateStart\')}',maxDate:'2020-10-01'})"  value="<bean:write name="employeeReportForm" property="salaryStartDateEnd" />"/>
						</li>
						
						<li>
							<label>薪资结束时间早于</label>
							<input type="text" name="salaryEndDateStart" class="Wdate search_salaryDateStart" id="search_salaryDateStart" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'search_salaryEndDateEnd\')||\'2020-10-01\'}'})"  value="<bean:write name="employeeReportForm" property="salaryEndDateStart" />"/>
						</li>
						<li>
							<label>薪资结束时间晚于</label>
							<input type="text" name="salaryEndDateEnd" class="Wdate search_salaryEndDateEnd" id="search_salaryEndDateEnd" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'search_salaryEndDateStart\')}',maxDate:'2020-10-01'})"  value="<bean:write name="employeeReportForm" property="salaryEndDateEnd" />"/>
						</li>
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			...
			<div id="tableWrapper" style="overflow: hidden;">
				...
				<jsp:include page="/contents/business/employee/report/table/listEmployeeSalaryReportBodyTable.jsp" flush="true"/> 
			</div>
			<!-- tableWrapper -->
			<div class="bottom">
				<p>
...
<script type="text/javascript">
	(function($) {
		...
		$('#menu_biz_Employee_Salary_Report').addClass('selected');
