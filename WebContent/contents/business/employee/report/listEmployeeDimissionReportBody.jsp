...
<div id="content">	
	...
	<div class="box searchForm toggableForm" id="Search-Information">
		<div class="head">
       		<label><bean:message bundle="business" key="business.employee.report.dimission" /></label>
   	    </div>
   	    ...
   	    <div id="searchDiv" class="inner" style="display: none;">
       		...
       		<html:form action="employeeReportAction.do?proc=list_object" method="post" styleClass="searchEmployeeReport_form">
				...
				<input type="hidden" name="rt" id="reportType" value="dimission" />
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			<div class="top">
				...
				<kan:auth right="export" action="<%=EmployeeReportAction.ACCESS_ACTION_DIMISSION%>"> 
			...
			<div id="tableWrapper" style="overflow: hidden;">
				...
				<jsp:include page="/contents/business/employee/report/table/listEmployeeDimissionReportBodyTable.jsp" flush="true"/> 
			</div>
			<!-- tableWrapper -->
			<div class="bottom">
				<p>
...
<script type="text/javascript">
	(function($) {
		...
		$('#menu_biz_Employee_Dimission_Report').addClass('selected');
