...
<table class="table hover" id="resultTable">
	<thead>
		<tr>
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("lastWorkDate")%>">
				<a onclick="submitForm('searchEmployeeReport_form', null, null, 'lastWorkDate', '<%=employeeReportHolder.getNextSortOrder("lastWorkDate")%>', 'tableWrapper');">
					<span id="lastWorkDate"><bean:message bundle="business" key="business.employee.report.last.in.group.date" /></span>&nbsp;&nbsp;
				</a>
			</th>
			<!--  
			...
			<th class="header-nosort">
				<span id="contractRemark5">HR Comments</span>&nbsp;&nbsp;
			</th>
		...
		<tbody>
			<logic:iterate id="employeeReportVO" name="employeeReportHolder" property="source" indexId="number">
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					...
					<td class="left"><bean:write name="employeeReportVO" property="lastWorkDate" /></td>
					<td class="left"><bean:write name="employeeReportVO" property="resignDate" /></td>
					<td class="left"><bean:write name="employeeReportVO" property="leaveReasons" /></td>
					<td class="left">
						<logic:notEmpty name="employeeReportVO" property="contractRemark5">
							<img src="images/tips.png" title="<bean:write name="employeeReportVO" property="contractRemark5" />">
						</logic:notEmpty>
					</td>
