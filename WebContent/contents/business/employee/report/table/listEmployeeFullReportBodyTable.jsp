...
<table class="table hover" id="resultTable">
	<thead>
		<tr>
			...
			<th class="header-nosort pm_hide">
				<span id="dynaColumns.minzu"><bean:message bundle="business" key="business.employee.report.nation" /></span>&nbsp;&nbsp;
			</th>
			<th class="header <%=employeeReportHolder.getCurrentSortClass("nationNality")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("certificateType")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("certificateNumber")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("certificateEndDate")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("birthday")%>">
				<a onclick="submitForm('searchEmployeeReport_form', null, null, 'birthday', '<%=employeeReportHolder.getNextSortOrder("birthday")%>', 'tableWrapper');">
						...
						<logic:notEmpty name="pm_hide">
							<span id="shortBirthday"><bean:message bundle="business" key="business.employee.report.birthday" /></span>&nbsp;&nbsp;
						</logic:notEmpty>
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("maritalStatus")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("personalAddress")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("residencyType")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("residencyAddress")%> pm_hide">
				<a onclick="submitForm('searchEmployeeReport_form', null, null, 'residencyAddress', '<%=employeeReportHolder.getNextSortOrder("residencyAddress")%>', 'tableWrapper');">
					<span id="residencyAddress"><bean:message bundle="business" key="business.employee.report.residencyAddress" /></span>&nbsp;&nbsp;
				</a>
			</th>
			<th class="header <%=employeeReportHolder.getCurrentSortClass("mobile1")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("phone1")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("personalEmail")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("bankId")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("bankAccount")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("residencyCityId")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("resignDate")%> pm_hide">
			...
			<th class="header <%=employeeReportHolder.getCurrentSortClass("leaveReasons")%> pm_hide">
		...
		<tbody id="mytab">
			...
			<bean:define id="defineEmployeeReportVO" name="employeeReportVO" toScope="request"></bean:define>
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeNationNality" /></td>
					<td class="left"><bean:write name="employeeReportVO" property="decodeSalutation" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeCertificateType" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="certificateNumber" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="certificateEndDate" /></td>
					<td class="left">
					
						<logic:notEmpty name="pm_hide">
							<bean:write name="employeeReportVO" property="shortBirthday" />
						</logic:notEmpty>
						<logic:empty name="pm_hide">
							<bean:write name="employeeReportVO" property="birthday" />
						</logic:empty>
						
					</td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeMaritalStatus" /></td>
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="personalAddress" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeResidencyType" /></td>
					<td class="left pm_hide">
						<logic:iterate id="dynaColumn" name="employeeReportVO" property="dynaColumns">
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="residencyAddress" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="mobile1" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="phone1" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="emergencyNames" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeRelationshipIds" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeContactType" /></td>
					<td class="left"><bean:write name="employeeReportVO" property="bizEmail" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="personalEmail" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeBank" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="bankAccount" /></td>
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="probationEndDate" /></td>
					<td class="left pm_hide">
						<logic:iterate id="dynaColumn" name="employeeReportVO" property="dynaColumns">
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeResidencyCityId" /></td>
					<td class="left pm_hide">
						<% 
					...
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="resignDate" /></td>
					<td class="left pm_hide"><bean:write name="employeeReportVO" property="decodeLeaveReasons" /></td>
					<td class="left">
						<logic:iterate id="dynaColumn" name="employeeReportVO" property="dynaColumns">
...
<script>
	(function($){
		...
		<logic:notEmpty name="pm_hide">
			$('table thead th.pm_hide').hide();
			$('table tbody td.pm_hide').hide();
		</logic:notEmpty>
