				...
				<fieldset>
					<ol class="auto">
						...
						<li>
							...
							<html:select property="employStatus" styleClass="search_employStatus">
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			<div class="top">
				...
				<kan:auth right="export" action="<%=EmployeeReportAction.ACCESS_ACTION_FULL%>"> 
			...
			<div id="tableWrapper" style="overflow: hidden;">
				...
				<jsp:include page="/contents/business/employee/report/table/listEmployeeFullReportBodyTable.jsp" flush="true"/> 
			</div>
			<!-- tableWrapper -->
			<div class="bottom">
				<p>
...
<script type="text/javascript">
	(function($) {
		...
		$('#menu_biz_Employee_Full_Report').addClass('selected');
	...
	function getTabTitle(){
		...
		<logic:notEmpty name="pm_hide">
			var oTTFirstTr = $('#_fixTableMain table thead tr th:visible span');
		</logic:notEmpty>
