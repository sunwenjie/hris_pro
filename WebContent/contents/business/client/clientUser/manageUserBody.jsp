...
<div id="content">
	<div id="systemUser" class="box toggableForm">
		<div class="head">
			...
			<label id="history" title="查看历史更改" onclick="showHistory();"><img src="images/label/history.png" /></label>
		</div>
		<div class="inner">
			<div class="top">
				...
				<fieldset>
					...
					<ol class="auto">
						<li>
							...
							<html:text property="staffName" maxlength="20" styleClass="user_staffname" /> 
	...
	<div class="box" id="history-results" style="display: none">
		<div class="head">
			<label id="pageTitle">历史编辑</label>
		</div>
		<div id="historyWrapper" class="historyinner">
			<logic:present name="historyUserVOs">
				<logic:iterate id="historyUserVO" name="historyUserVOs" indexId="number">
					<div class="historytitle <%=number % 2 == 1 ? "even" : "odd"%>"><a onclick="loadHistoryRecord('<bean:write name="historyUserVO" property="historyId" />', 'userAction.do?proc=get_history_object_html');"><bean:write name="historyUserVO" property="hisTitle" /></a></div>
					<div id="historyrecord_<bean:write name="historyUserVO" property="historyId" />" class="historyrecord"></div>
				</logic:iterate>
			</logic:present>
		</div>
	</div>
...
<script type="text/javascript">
	(function($) {
		...
		function btnSubmit() {
			var flag = 0;
			flag = flag + validate('user_staffname', true, 'common', 20, 3);
			
			if($('.user_username').val() != 'Admin'){
				flag = flag + validate('user_username', true, 'common', 20, 5);
			}
