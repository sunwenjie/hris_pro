		...
		<tbody id="mytab">
			<logic:iterate id="sbDetailVO" name="sbDetailHolder" property="source" indexId="number">
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					...
					<td class="left"><bean:write name="sbDetailVO" property="decodeStatus" />
					<logic:notEmpty name="sbDetailVO" property="workflowId" >
						&nbsp;&nbsp;<img src='images/magnifer.png' onclick=popupWorkflow('<bean:write name="sbDetailVO" property="workflowId"/>'); />
					</logic:notEmpty>
					 </td>
				</tr>
			</logic:iterate>
