		...
		<tbody>
			<logic:iterate id="cbBatchVO" name="cbBatchHolder" property="source" indexId="number">
				<tr class='<%=number % 2 == 1 ? "odd" : "even"%>'>
					...
					<td class="left"><a href="#" onclick="link('cbHeaderAction.do?proc=list_object&statusFlag=preview&batchId=<bean:write name="cbBatchVO" property="encodedId"/>');"><bean:write name="cbBatchVO" property="batchId" /></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="link('cbHeaderAction.do?proc=list_object&statusFlag=preview&batchId=<bean:write name="cbBatchVO" property="encodedId"/>');"></a></td>								
