...
<div id="content">
	<div class="box searchForm toggableForm" id="cbBatch-information">
		<div class="head">
			<label><bean:message bundle="cb" key="cb.submit.search.title" /></label>
		</div>
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			...
			<div class="top">
				<kan:auth right="submit" action="HRO_CB_BATCH_SUBMIT">
			...
			<!-- Include table jsp 包含tabel对应的jsp文件 -->  
				<jsp:include page="/contents/cb/table/listCBBatchTableSubmit.jsp" flush="true"/> 
			</div>
		...
		$('#btnSubmit').click(function(){
			if($('#selectedIds').val() != null && $('#selectedIds').val() != ''){
				if(confirm('<bean:message bundle="public" key="popup.confirm.submit.selected.batch" />')){
					$('.list_form').attr('action', 'cbAction.do?proc=submit_settlement');
