...
<div id="content">
	<div class="box searchForm toggableForm" id="cbBatch-information">
		<div class="head">
			<label><bean:message bundle="cb" key="cb.confirm.search.title" /></label>
		</div>
				...
				<fieldset>
					<ol class="auto">
						<li>
							...
							<html:text property="batchId" maxlength="20" styleClass="searchCBBatch_batchId" /> 
						</li>
						<li>
	...
	<div class="box noHeader" id="search-results">
		<div class="inner">
			...
			<!-- Include table jsp 包含tabel对应的jsp文件 -->  
				<jsp:include page="/contents/cb/table/listCBBatchTableConfirm.jsp" flush="true"/> 
			</div>
		...
		$('#btnConfirm').click(function(){
			if($('#selectedIds').val() != null && $('#selectedIds').val() != ''){
				if(confirm('<bean:message bundle="public" key="popup.confirm.confirm.selected.batch" />')){
					$('.list_form').attr('action', 'cbAction.do?proc=submit_confirmation');
