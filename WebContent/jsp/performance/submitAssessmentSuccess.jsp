	...
	<div id="wrapper">
		...
		<div id="content" style="padding-top: 0px; text-align: center; min-height: 300px;">
			...
			<div id="submit-success" class="box">	
				<p><img src="mobile/images/success.png" style="width: 64px;height: 64px;"></p>
				<p>
					<bean:message bundle="performance" key="invite.submit.success" />
					<a onclick="link('inviteAssessmentAction.do?proc=to_objectModify&randomKey=<bean:write name="randomKey" />');">
						<bean:message bundle="performance" key="invite.assessment.link.back.view" />
					</a>
				</p>
			</div>
