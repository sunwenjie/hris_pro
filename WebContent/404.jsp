...
.logo,.tower,.cruise{background:url(images/logo/un_pic.png) no-repeat;}
.wrap{background:#1158e7 url(images/logo/404_bg.jpg) no-repeat center bottom;width:100%;overflow:hidden;}
.content{position:relative;z-index:1;height:480px;margin:0 auto;padding-top:100px;}
.logo{ position: relative;z-index:5; width:220px;height:54px;margin:0 auto;overflow:hidden;text-indent:-500px;background-position:0 0;}
...
.wave1{position:relative;z-index:3;width:100%;margin-top:-220px;color:#999;background:url(images/logo/bl.png) repeat-x 0 0;-webkit-animation:8s linear 0s none infinite tweenxx;-moz-animation:8s linear 0s none infinite tweenxx;animation:8s linear 0s none infinite tweenxx;}
.wave{height:220px;background:url(images/logo/bl.png) repeat-x 330px 0;-webkit-animation:10s linear 0s none infinite tweenx;-moz-animation:10s linear 0s none infinite tweenx;animation:10s linear 0s none infinite tweenx;}
...
<body>
	<div class="wrap">
		<div class="content">
			<a href="dashboardAction.do?proc=showDashboard"><h1 class="logo">Ctrip</h1></a>
			
			<div class="errorinfo">
				
				<a class="goback" href="dashboardAction.do?proc=showDashboard">·µ»ØÊ×Ò³</a>				
			</div>
			<div class="miscbox">
				<div class="tower"></div>
	...
	<div id="footer">		
		<p class="copyright">
			&copy;<%= BaseAction.getTitle( request, response ) %> <%= KANConstants.VERSION %>a °æ KANGROUP 2013 - 2014 <bean:message key="footer.allrightreserved" />
		</p>
	</div>
</body>
</html>
