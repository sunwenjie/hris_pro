 ...
 * 创建时间：2014-4-18  
 */
public class SBHeaderTempVO extends BaseVO
{
   // serialVersionUID
   private static final long serialVersionUID = -4356208121350986723L;
    ...
    */
   // “新建”状态
   public static String TEMPSTATUS_NEW = "1";

   // “已更新”状态
   public static String TEMPSTATUS_UPDATED = "2";
   ...
   // 临时表导入状态
   private List< MappingVO > tempStatuses = new ArrayList< MappingVO >();
   ...
   // 获得社保状态
   public String getDecodeTempStatus() throws KANException
   {
      return decodeField( tempStatus, tempStatuses );
   }
