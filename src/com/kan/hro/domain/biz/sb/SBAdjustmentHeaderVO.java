...
public class SBAdjustmentHeaderVO extends BaseVO
{
   ...
   public void reset( final ActionMapping mapping, final HttpServletRequest request )
   {
      ...
      super.setStatuses( KANUtil.getMappings( this.getLocale(), "business.sb.adjustment.header.status" ) );
   ...
   {
      final SBAdjustmentHeaderVO sbAdjustmentHeaderVO = ( SBAdjustmentHeaderVO ) object;
