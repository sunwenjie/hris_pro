...
public class BatchVO extends BaseVO
{
   ...
   {
      final BatchVO batchVO = ( BatchVO ) object;
      this.entityId = batchVO.getEntityId();
      this.businessTypeId = batchVO.getBusinessTypeId();
      this.clientId = batchVO.getClientId();
      this.orderId = batchVO.getOrderId();
      this.monthly = batchVO.getMonthly();
      this.weekly = batchVO.getWeekly();
      this.containSalary = batchVO.getContainSalary();
      this.containSB = batchVO.getContainSB();
      this.containCB = batchVO.getContainCB();
      this.containServiceFee = batchVO.getContainServiceFee();
      this.containOther = batchVO.getContainOther();
      this.accountPeriod = batchVO.getAccountPeriod();
      this.startDate = batchVO.getStartDate();
      this.endDate = batchVO.getEndDate();
      this.description = batchVO.getDescription();
      super.setStatus( batchVO.getStatus() );
   ...
   {
      if ( this.getContainSalary() == null || this.getContainSalary().trim().equals( "0" ) )
      {
         return null;
      }
   ...
   {
      if ( this.getContainCB() == null || this.getContainCB().trim().equals( "0" ) )
      {
         return null;
      }
   ...
   {
      if ( this.getContainServiceFee() == null || this.getContainServiceFee().trim().equals( "0" ) )
      {
         return null;
      }
   ...
   {
      if ( this.getContainOther() == null || this.getContainOther().trim().equals( "0" ) )
      {
         return null;
      }
   ...
   public final String getBatchTempId()
   {
      return batchTempId;
   }

   public final void setBatchTempId( String batchTempId )
   {
      this.batchTempId = batchTempId;
   }
