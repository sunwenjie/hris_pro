...
public class AdjustmentHeaderVO extends BaseVO
{

   // Serial Version UID  
   private static final long serialVersionUID = -6535153179807144614L;
   ...
   public void reset( final ActionMapping mapping, final HttpServletRequest request )
   {
      ...
      super.setStatuses( KANUtil.getMappings( this.getLocale(), "business.settlement.adjustment.header.status" ) );
