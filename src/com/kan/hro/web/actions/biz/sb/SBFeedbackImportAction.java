...
public class SBFeedbackImportAction extends BaseAction
{
   public final static String ACCESSACTION = "HRO_SB_HEADER_TEMP";
   ...
   public ActionForward list_object( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws KANException
   {
      try
      {
         ...
         // Holder需写入Request对象
         request.setAttribute( "sbFeedbackHolder", pagedListHolder );
         ...
         if ( commonBatchVO.getSelectedIds() != null && !commonBatchVO.getSelectedIds().trim().isEmpty() )
         {
            ...
            for ( String selectedId : commonBatchVO.getSelectedIds().split( "," ) )
            {
               if ( selectedId != null && !selectedId.equals( "null" ) )
               {
                  ...
                  // 调用接口
                  rows += sbFeedbackHeaderTempService.updateBatch( tempCommonBatchVO );
               }
