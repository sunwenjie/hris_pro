...
public class TaxTemplateDetailVO extends BaseVO
{

   /**  
   * Serial Version UID 
   */
   private static final long serialVersionUID = -187628860474811725L;
   ...
   {
      final TaxTemplateDetailVO taxTemplateDetailVO = ( TaxTemplateDetailVO ) object;
      this.propertyName = taxTemplateDetailVO.getPropertyName();
      this.nameZH = taxTemplateDetailVO.getNameZH();
      this.nameEN = taxTemplateDetailVO.getNameEN();
      this.valueType = taxTemplateDetailVO.getValueType();
      this.columnWidth = taxTemplateDetailVO.getColumnWidth();
      this.columnIndex = taxTemplateDetailVO.getColumnIndex();
      this.fontSize = taxTemplateDetailVO.getFontSize();
      this.isDecoded = taxTemplateDetailVO.getIsDecoded();
      this.datetimeFormat = taxTemplateDetailVO.getDatetimeFormat();
      this.accuracy = taxTemplateDetailVO.getAccuracy();
      this.round = taxTemplateDetailVO.getRound();
      this.align = taxTemplateDetailVO.getAlign();
      this.description = taxTemplateDetailVO.getDescription();
      super.setStatus( taxTemplateDetailVO.getStatus() );
