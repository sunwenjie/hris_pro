...
public interface SkillService
{
   ...
   public abstract List< SkillBaseView > getSkillBaseViewsByAccountId( final String accountId, final String corpId ) throws KANException;

   public abstract List< SkillDTO > getSkillDTOsByAccountIdOptimize( String accountId ) throws KANException;
}
